...
Hull PyramidCollisionShape::m_CubeHull = Hull();
...
void PyramidCollisionShape::ConstructCubeHull()    // similar to cuboid collision shape, but changed vertices and faces
{
	//Vertices
	...
	m_CubeHull.AddVertex(Vector3(0.0f, 1.0f, 0.0f));        // 4
	...
	//Faces
	m_CubeHull.AddFace(Vector3(0.0f, 0.0f, -1.0f), 3, face1);
	m_CubeHull.AddFace(Vector3(0.0f, 0.0f, 1.0f), 3, face2);
	m_CubeHull.AddFace(Vector3(0.0f, 1.0f, 0.0f), 3, face3);
	m_CubeHull.AddFace(Vector3(0.0f, -1.0f, 0.0f), 3, face4);
