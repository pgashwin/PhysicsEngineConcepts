...
public:
	...
	static Mesh* texturedSpehre() { return m_texturedSpehere; } //Textured Sphere
	static Mesh* pyramid() { return m_pyramid; } //pyramid
...
protected:
	...
	static Mesh* m_pyramid;
	
	static Mesh* m_texturedSpehere;
