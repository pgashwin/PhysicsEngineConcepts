...
public:
	...
	virtual void PreSolverStep(float dt)
	{
		...
		*/
		...
		this->j3 = abn;
		this->j4 = Vector3::Cross(r2, abn); //	Baumgarte Offset(Adds energy to	the	system to counter slight solving errors that accumulate over time-known as 'constraint drift')
		{
